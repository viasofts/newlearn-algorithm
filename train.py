...
from yolov7_models.yolo import Model
...
if __name__ == "__main__":
    ...
    hyp = os.path.join(os.getcwd(), "data/hyp.scratch.p5.yaml")

    weights = ""

    # Yolov7 네트워크가 저장된 confing 파일
    cfg = os.path.join(os.getcwd(), "cfg", "training", "yolov7-tiny.yaml")
