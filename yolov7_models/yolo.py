...
import torch
from yolov7_models.common import *
from yolov7_models.experimental import *
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                if self.inplace:
                    ...
                    if self.nkpt != 0:
                        x_kpt[..., 0::3] = (
                            (x_kpt[..., ::3] * 2.0 - 0.5 + kpt_grid_x.repeat(1, 1, 1, 1, 17)) * self.stride[i]
                        )  # xy
                        x_kpt[..., 1::3] = (
                            (x_kpt[..., 1::3] * 2.0 - 0.5 + kpt_grid_y.repeat(1, 1, 1, 1, 17)) * self.stride[i]
                        )  # xy
                    ...
                    if self.nkpt != 0:
                        y[..., 6:] = (
                            (y[..., 6:] * 2.0 - 0.5 + self.grid[i].repeat((1, 1, 1, 1, self.nkpt))) * self.stride[i]
                        )  # xy
